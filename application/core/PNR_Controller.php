...
class PNR_Controller extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->data['is_loggedin'] = !empty($this->session->userdata('id')) && ($this->session->userdata('realm') === $this->config->item('rest_realm'));
    }
