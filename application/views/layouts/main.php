				...
				<div id="lower-header">
					...
					<ul id="navigation">
						...
						<li class="donate-button <?php if($this->data['current-menu-item'] == 'Donate Today') echo 'current-menu-item'; ?>">
                                                    <?php if (!$this->data['is_loggedin']) { ?>
							<a href="https://partidulnouaromanie.ro/social/signup" target="_blank">Înscrie-te !</a>
                                                    <?php } else { ?>
                                                        <a href="/logout"><?php echo $this->lang->line('logout') ?></a>
                                                    <?php } ?>
						</li>
						<!-- /Donate -->
